# MathStick — SceneBuilder (the UI generator)
...
> **This file builds the entire interface.** Nothing in the scene is hand-made;
> the next `PlusMinus > Build Scene` overwrites anything edited by hand.
...
## `Assets/Editor/AndroidBuildSetup.cs`
...
## `Assets/Editor/SceneBootstrap.cs`
